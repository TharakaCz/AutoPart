...
public class GigDTO {
    ...
    public GigDTO(int gId) {
        this.setgId(gId);
    }

    public GigDTO(int gId, String gTitle, String gSearchTag, String gPic, String gCatogary, String gCoust, String gSellerName, String gSellerCompanny, int qty, double unitPrice, double bonus, String gScontact, String gSemail) {
        this.setgId(gId);
    ...
    public GigDTO(String gTitle, String gSearchTag, String gPic, String gCatogary, String gCoust, String gSellerName, String gSellerCompanny, int qty, double unitPrice, double bonus, String gScontact, String gSemail) {
        this.setgTitle(gTitle);
        this.setgSearchTag(gSearchTag);
        this.setgPic(gPic);
        this.setgCatogary(gCatogary);
